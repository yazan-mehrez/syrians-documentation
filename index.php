...
<html>
  <head>
      ...
      <title>Syrians - Documentation</title>
  ...
  <body>
    <nav>
      ...
      <ul class="menu">
        ...
        <li class="menu__item"><a href="components.php" class="link link--dark"><i class="fa fa-book"></i> Documentation</a></li>
      </ul>
    </nav>
    <div class="hero">
      <h1 class="hero__title">Syrians Documentation</h1>
      <p class="hero__description">All code and functions</p>
    </div>
